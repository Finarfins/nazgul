...
def test_BAS_TEK_ve_0073_zincirin_UCUNDA(motor) -> None:
    ...
    `20260910_0080`dır (WA4, WhatsApp bekleyen işlem defteri) ve 0073 hâlâ
    zincirin İÇİNDE — yukarıdaki `test_GOC_TURU_BOS_TABLO_...` turu onu
    MUTLAK hedefle adıyla sürüyor.
    """
