...
class HarvestTicketWrite(_Taban):
    ...
    girilebilir; bedel migration 0064 başlığında adı konmuş hâliyle kabul
    edilmiştir.
    """

    harvest_id: int = Field(gt=0)
    # KALİTE KESİNTİLERİNDEN ÖNCEKİ ÜRÜN AĞIRLIĞI — araç+yük DEĞİL.
    # Bkz. migration 0064 başlığı: karıştırılması hata değil CEVAP üretir.
    gross_quantity: Decimal = Field(gt=0, le=MAX_MIKTAR)
